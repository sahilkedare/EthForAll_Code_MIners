...
const RegisterInsuraceComp = ({ modalIsOpen, closeModal }) => {
  const { registerInsuranceComp } = useContext(EHRContext);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await registerInsuranceComp(name, emailId, mobileNo);
    } catch (err) {
      console.log(err);
    }
  };
...
export default RegisterInsuraceComp;
